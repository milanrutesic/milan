<?php
	...
	********************************************/
	...
	$SandboxFlag = $config->sandboxFlag;
	...
	//'------------------------------------
	$API_UserName = $config->myApiUsername;
	$API_Password = $config->myApiPassword;
	$API_Signature= $config->myApiSignature;
	...
	*/
	...
	'--------------------------------------------------------------------------------------------------------------------------------------------	
	*/
	function CallShortcutExpressCheckout( $paymentAmount, $currencyCodeType, $paymentType, $returnURL, $cancelURL, $paymentId) 
	{
		//------------------------------------------------------------------------------------------------------------------------------------
		// Construct the parameter string that describes the SetExpressCheckout API call in the shortcut implementation
		global $putuySession, $db;
		...
		if($ack=="SUCCESS"){
			...
			// Write this token into payments table for the current payment id
			$data = array('token' => $token);
			$db->update('payments', $data,"payment_id = '$paymentId'");
		}
